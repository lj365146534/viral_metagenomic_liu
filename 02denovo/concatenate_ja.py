#!/home/ngs2/anaconda3/envs/py3/bin/python
#佳改文件2022/02/22
import sys
import os
import argparse
...
for i in open(args.inpaths[0],'r').readlines():
#    print(i)
    tt = 'cp 01megahit/'+i.strip()+'/final.contigs.fa contigs/'+i.strip()+'.contigs.fa'
#    print(tt)
    os.system(tt)
args.inpaths = ['contigs/'+i.strip()+'.contigs.fa' for i in open(args.inpaths[0],'r').readlines()]
